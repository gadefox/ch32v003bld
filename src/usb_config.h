...
static const uint8_t device_descriptor[] = {
    ...
    0x09,
    0x12, // ID Vendor   // TODO: register this in http://pid.codes/howto/ or somewhere.
    0x03,
    0xb0, // ID Product
    0x00,
    0x00, // ID Rev (bcdDevice)
...
static const uint8_t config_descriptor[] = {
    ...
    0x00, // Descriptor length XXX This looks wrong!!!
